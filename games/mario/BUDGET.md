...
| 5 | flow.c, powerup.c, title.c, hud.c, save.c, mapscreen.c, camera.c, level.c | 11490 |
| 6 | the draw passes (player_draw, blocks_draw, debris, popup), states.c, pause.c, toad.c, castle art, 1-4 grid | 8419 |
