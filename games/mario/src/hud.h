...
// arms the level's countdown and re-places the five digit sprites; a respawn shares it
...
// one frame of the countdown, the coin rollover and the digit sprites; 1 on the frame time ran out
