...
// the wordmark's five palettes and the script's gold, swapped between their own colors and all
// white: title_frame alternates them while the title is leaving for the file select
